...
void TestMaximumMultiKeyProofRoundTrip() {
  ...
  BlindzapStatementV1 s; s.network=BlindzapNetwork::kRegtest; s.verifier="multi-test"; s.purpose="proof-of-funds"; s.expires_at=1; s.nonce[0]=1; s.bip322_message_hash[0]=1;
  ...
  auto trailing_proof=parsed; trailing_proof.proof.bytes.push_back(0); Require(!BlindzapVerifyProof(trailing_proof),"proof trailing byte accepted");
