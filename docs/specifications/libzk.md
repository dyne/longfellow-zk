---
title: libzk protocol draft
description: Upstream working specification of the complete Longfellow zero-knowledge argument.
outline: deep
---

# libzk protocol draft

::: warning Upstream working document
This is a rendering-oriented mirror of `vendor/longfellow-zk/docs/specs/libzk.md`
at the submodule revision pinned by this repository. Citation XML and
Internet-Draft generation metadata were removed for VitePress; algorithms and
pseudocode are preserved. Consult the [IETF Datatracker](https://datatracker.ietf.org/doc/draft-google-cfrg-libzk/)
and vendored source before treating any requirement as normative.
:::
...
The commitment subprotocol is published separately in this site as the
[Ligero specification](ligero.md).
...
The interactive-proof component is published separately as the
[sumcheck specification](sumcheck.md).
...
Concrete fixtures are published in [protocol test vectors](test-vectors.md).
