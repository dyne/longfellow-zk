---
title: Ligero specification
description: Commitment, Merkle opening, low-degree, and constraint proof procedures used by Longfellow.
outline: deep
---

# Ligero specification

::: info Source mirror
Mirrored from `vendor/longfellow-zk/docs/specs/ligero.md`. Citation-generation
XML was removed for VitePress. The primary paper is
[Ames et al., 2022](https://eprint.iacr.org/2022/1608).
:::
